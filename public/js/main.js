...
function add_css() {
  ...
  style.id = "svelte-7eedz-style";
  style.textContent = "main.svelte-7eedz{text-align:center;padding:1em;max-width:240px;margin:0 auto;background:black}@media(min-width: 640px){main.svelte-7eedz{max-width:none}}";
...
function create_fragment(ctx) {
  ...
  video = new _components_video_svelte__WEBPACK_IMPORTED_MODULE_1__.default({
    props: {
      url: "/media/Ted-Kasyncski-unabomber-anime.mp4"
    }
  });
  return {
    c: function c() {
      ...
      (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.attr)(main, "class", "svelte-7eedz");
    },
    m: function m(target, anchor) {
      (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.insert)(target, main, anchor);
      (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.mount_component)(controls, main, null);
      (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.append)(main, t);
      (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.mount_component)(video, main, null);
      current = true;
    },
    ...
    d: function d(detaching) {
      ...
      (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.destroy_component)(video);
    }
  };
}
...
var App = /*#__PURE__*/function (_SvelteComponent) {
  ...
  function App(options) {
    ...
    if (!document.getElementById("svelte-7eedz-style")) add_css();
...
function create_fragment(ctx) {
  ...
  return {
    c: function c() {
      ...
      ctx[0])) (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.attr)(source, "src", source_src_value);
      (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.attr)(track, "kind", "captions");
      (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.attr)(video, "id", "media-player");
      video.muted = true;
      (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.attr)(video, "class", "svelte-1lb50o0");
    },
    m: function m(target, anchor) {
      (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.insert)(target, video, anchor);
      (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.append)(video, source);
