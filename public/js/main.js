...
/* harmony import */ var _video_svelte__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./video.svelte */ "./src/video.svelte");
...
function add_css() {
  ...
  style.id = "svelte-1pjgtjm-style";
  style.textContent = "main.svelte-1pjgtjm{text-align:center;padding:1em;max-width:240px;margin:0 auto}h1.svelte-1pjgtjm{color:#ff3e00;text-transform:uppercase;font-size:4em;font-weight:100}@media(min-width: 640px){main.svelte-1pjgtjm{max-width:none}}";
...
function create_fragment(ctx) {
  ...
  return {
    c: function c() {
      ...
      (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.attr)(h1, "class", "svelte-1pjgtjm");
      (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.attr)(main, "class", "svelte-1pjgtjm");
    },
...
var App = /*#__PURE__*/function (_SvelteComponent) {
  ...
  function App(options) {
    ...
    if (!document.getElementById("svelte-1pjgtjm-style")) add_css();
...
/* src/video.svelte generated by Svelte v3.38.2 */
...
function create_fragment(ctx) {
  ...
  return {
    c: function c() {
      ...
      video.innerHTML = "<source src=\"\"/><track kind=\"captions\"/>";
